...
tf.flags.DEFINE_string("positive_data_file", "./data/rt-polaritydata/twtdemtrain2.txt", "Data source for the positive data.")
tf.flags.DEFINE_string("negative_data_file", "./data/rt-polaritydata/twtreptrain2.txt", "Data source for the negative data.")
